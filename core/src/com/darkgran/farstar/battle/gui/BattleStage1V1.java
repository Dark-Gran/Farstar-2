...
public class BattleStage1V1 extends BattleStage {
    ...
    public BattleStage1V1(Farstar game, Viewport viewport, BattleScreen battleScreen, DuelMenu duelMenu, Player player1, Player player2) {
        ...
        //Shipyards
        yardMenu1 = new YardMenu(player1.getShipyard(), false, 217f, Farstar.STAGE_HEIGHT*0.078f, this, player1);
        yardButton1.setPosition(Farstar.STAGE_WIDTH*0.112f, Farstar.STAGE_HEIGHT*0.029f);
        this.addActor(yardButton1);
        yardMenu2 = new YardMenu(player2.getShipyard(), true, 217f, Farstar.STAGE_HEIGHT*0.78f, this, player2);
