...
public class DuelMenu1v1 extends DuelMenu {
    ...
    public DuelMenu1v1(DuelManager duelManager) {
        super(duelManager);
        duelButton1 = new DuelOK(Farstar.ASSET_LIBRARY.get("images/duel.png"), Farstar.ASSET_LIBRARY.get("images/duelO.png"), duelManager);
        duelButton2 = new DuelOK(Farstar.ASSET_LIBRARY.get("images/duel.png"), Farstar.ASSET_LIBRARY.get("images/duelO.png"), duelManager);
